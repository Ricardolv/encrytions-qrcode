...
public class QrCodeTwo {

    private final String DIR = "/home/richard/git/encrytions-qrcode/src/main/resources/images";
    private final String ext = ".png";
    private final String LOGO = "/home/richard/git/encrytions-qrcode/src/main/resources/images/logo.png";
    ...
    public void generate() {
        ...
        try {
            ...
            // Load logo image
            BufferedImage overly = ImageIO.read(logo);
    ...
    private MatrixToImageConfig getMatrixConfig() {
        // ARGB Colors
        // Check Colors ENUM
        return new MatrixToImageConfig(QrCodeTwo.Colors.WHITE.getArgb(), QrCodeTwo.Colors.ORANGE.getArgb());
    }
    ...
    public static void main(String[] args) {
        QrCodeTwo qrCodeTwo = new QrCodeTwo();
        qrCodeTwo.generate();
    }
